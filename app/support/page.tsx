  ...
  return (
    <InfoPage
      ...
      sections={[
        ...
        {
          title: "Удаление аккаунта и копия данных",
          body: [
            `Чтобы запросить удаление аккаунта или копию своих данных, напишите на ${email} с email-адреса, который используется в DARKKICK.`,
            "В письме укажите, что именно нужно сделать: удалить аккаунт или подготовить копию данных.",
          ],
        },
        {
          title: "Ответ",
